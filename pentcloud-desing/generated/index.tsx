...
export type ArticulosQuery = { __typename: 'Query', posts: { __typename: 'PagePost', pages: number, rows: Array<{ __typename?: 'Post', id: any, title: string, body: string, categories: Array<{ __typename?: 'Category', id: any, name: string }>, author: { __typename?: 'Author', id: any, name: string } }> } };
